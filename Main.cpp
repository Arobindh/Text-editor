...
int main(int argc, char* argv[])
{
	...
	if (argc == 2)
	{						// only one argument, a file name expected
		filename = argv[1];
	};
...
//	ed.runCommand("z1,$");		// bad command
	...
	// net the given invalid line range
	...
	//ed.runCommand("v");			// paste into empty buffer
	//ed.runCommand("1,$");		// print all
